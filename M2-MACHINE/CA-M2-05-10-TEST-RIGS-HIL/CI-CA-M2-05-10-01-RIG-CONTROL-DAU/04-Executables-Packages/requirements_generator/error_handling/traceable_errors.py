# error_handling/traceable_errors.py
import traceback
import uuid
import json
import os
...
class TraceableError(Exception):
    """Base error class with full traceability"""
...
class ErrorReporter:
    """Centralized error reporting with debugging aids"""
    ...
    def generate_debugging_hints(self, error: TraceableError) -> List[str]:
        """Generate context-specific debugging hints"""
        hints: List[str] = []
